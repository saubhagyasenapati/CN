// 3.
// Write a program to create a TCP socket in which client will sent an integer array to the server .Server will sort the array in acesnding order and return 
// back to the client.

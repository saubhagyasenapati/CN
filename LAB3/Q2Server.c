// 2.
// Write a c program to create a TCP socket through which client will sent an integer number to the server.Server will return back
// the reverse of that number to the client.
